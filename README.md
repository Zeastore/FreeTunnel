...
### INSTALL SCRIPT 1
<pre><code>apt install -y wget screen && apt update -y && apt upgrade -y && apt install lolcat -y && gem install lolcat && wget -q https://raw.githubusercontent.com/Zeadxt/rzk/main/main.sh && chmod +x main.sh && screen -S install ./main.sh</code></pre>

### PERINTAH UPDATE 
<pre><code>wget https://raw.githubusercontent.com/Zeadxt/rzk/main/update.sh && chmod +x update.sh && ./update.sh</code></pre>
...
MOD BY: FREE TUNNELING PROJECT
ORIGINAL BY : RIZKIHDYT06
